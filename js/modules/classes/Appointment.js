...
import { loadEdit, clearObject, deleteAppointemente } from "../functions.js";
import { edit, DB } from "../variables.js";
export default class Appointment {
    ...
    showAp() {
        ...
        const objectStore = DB.value.transaction('appointment').objectStore('appointment');
        ...
        objectStore.openCursor().onsuccess = function(e){
            ...
            if(cursor){
                const { id, pet, owner, email, date, symptoms } = cursor.value

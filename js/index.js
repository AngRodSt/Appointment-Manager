...
class Appointment {
    ...
    showAp() {
        ...
        this.appointment.forEach(appointment => {
            ...
            btnEdit.classList.add('py-2', 'px-10', 'bg-indigo-600', 'hover:bg-indigo-700', 'text-white', 'font-bold', 'uppercase', 'rounded-lg', 'flex', 'items-center', 'text-center','gap-2', 'sm:w-full');
